    ...
    <main className="min-h-screen bg-background p-6">
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {pendingTodos.map(todo => (
                    <div key={todo.id} className="flex items-center justify-between gap-2">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => removeTodo(todo.id)}><X className="h-4 w-4" /></Button>
                    </div>
                  ))}
                </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="course-name" value={newCourseName} onChange={e => setNewCourseName(e.target.value)} placeholder="e.g. Calculus I" />
            </div>
            <div>
              <label htmlFor="course-desc" className="block text-sm font-medium text-gray-700">Description</label>
              <Input id="course-desc" value={newCourseDescription} onChange={e => setNewCourseDescription(e.target.value)} placeholder="Brief description" />
            </div>
          </div>
          <DialogFooter>
      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="google-link" className="block text-sm font-medium text-gray-700 mb-2">Google Calendar Link</label>
            ...
            <div>
              ...
              <Input id="canvas-link" value={canvasLink} onChange={e => setCanvasLink(e.target.value)} placeholder="https://..." />
            </div>
          </div>
          <DialogFooter>
